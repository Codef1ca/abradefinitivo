      ...
      >
        <div className='texto-card'>
          <Image
            ...
            className="flecha"
          />
          <h2 className='titulo-card-prod'>Tomate Cherri</h2>
          <p className='p-card-prod'>Contamos con dos coloraciones distintas de tomate Cherry: ROJO y AMARILLO. Ambas con intensidad de colores y brillos excelentes y tamaños que rondan los 4 a 5 cm.
</p>
        </div>
      </motion.div>
    </motion.div>
