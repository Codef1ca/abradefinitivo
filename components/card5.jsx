    ...
    >
      ...
      >
        <div className='texto-card'>
          ...
          <p className='p-card-prod'>Buen tamaño, otorgando mucha fruta en calibres centrales. Cuenta con una gran firmeza y fuerte resistencia a temperaturas elevadas. Contamos con variedad Jilguero, Nativo y Regina.
</p>
        </div>
      </motion.div>
    </motion.div>
